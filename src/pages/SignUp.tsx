...
import { Box, Grid, Stack, StepLabel, Theme, useMediaQuery } from '@mui/material';
...
const steps = [
  ...
  { title: 'Medical Information', content: 'Provide your medicare information' },
...
export default function SignUp() {
  ...
  const components = [PersonalDetailForm, ContactDetailForm, MedicalDetailForm, RegisterDetailForm];
      ...
      >
        {allStepsCompleted() ? (
          ...
          >
            ...
            <StyledButton sx={{ marginTop: '4em' }} onClick={handleReset}>
              Go to dashboard
            </StyledButton>
          </Stack>
        ) : (
